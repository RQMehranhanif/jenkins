...
<body>
	...
	{{-- INCLUDING SUPER BILL IN CAREPLAN --}}
	@include('superbill.super-bill-pdf', ['row' => $superBilldata])

	{{-- CDC guidelines for Physical activity --}}
	<img src="{{asset('guidelines/Guidelines for Physical Activity.png') }}" width="100%" height="100%">

	{{-- CDC guidelines for Alcohol --}}
	<img src="{{asset('guidelines/Dietary Guidelines for Alcohol.png') }}" width="100%" height="100%">

	{{-- CDC guidelines for Tobacco --}}
	<img src="{{asset('guidelines/The Harmful Effects of Tobacco Use.png') }}" width="100%" height="100%">

	{{-- CDC guidelines for Nutition --}}
	<img src="{{asset('guidelines/DGA_2020-2025_ExecutiveSummary-1.png') }}" width="100%" height="100%">
	<img src="{{asset('guidelines/DGA_2020-2025_ExecutiveSummary-2.png') }}" width="100%" height="100%">
	<img src="{{asset('guidelines/DGA_2020-2025_ExecutiveSummary-3.png') }}" width="100%" height="100%">
	<img src="{{asset('guidelines/DGA_2020-2025_ExecutiveSummary-4.png') }}" width="100%" height="100%">
