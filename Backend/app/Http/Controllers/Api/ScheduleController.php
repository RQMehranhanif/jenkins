...
class ScheduleController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            foreach($result['data'] as $key => $val){
                /* $patient = array_filter($Patients_data,function($item) use($val) {
                    return $item['id'] === $val['patient_id'];
                });
...

    {
        ...
        //$record_find = Questionaires::where('patient_id',$id)->get('id');



        //$last_AWV = Questionaires::where('patient_id' , $id)->latest('created_at')->first()->created_at;



   /*$last_AWV = Schedule::with('last_visit')->latest('created_at')->get()->toArray();*/



//return response()->json($record_find);
      ...
      /*  try {
            ...
            $schedule_resource = new ScheduleCollection($schedule);
        ...
        try {
...

            {
               ...
               $response = [
                ...
                'message' => 'Sorry schedule Not Find',
            ...
            $response = [
                ...
                'message' => 'Patienter Data Fetch Successfully',
...

    {
        ...
        $last_AWV = Questionaires::where('patient_id',$request->patient_id)->orderBy('id','Desc')->first();
